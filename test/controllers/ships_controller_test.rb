...
class ShipsControllerTest < ActionController::TestCase
  ...
  test "should create ship" do
    assert_difference('Ship.count') do
      post :create, ship: { line_id: @ship.line_id, port_of_origin_id: @ship.port_of_origin_id, title: @ship.title }
    end
  ...
  test "should update ship" do
    patch :update, id: @ship, ship: { line_id: @ship.line_id, port_of_origin_id: @ship.port_of_origin_id, title: @ship.title }
    assert_redirected_to ship_path(assigns(:ship))
  end
